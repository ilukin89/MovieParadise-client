...
import { Form, Button, Card, CardGroup, Container, Row, Col, Image } from 'react-bootstrap';
...
export class ProfileView extends React.Component {
  ...
  getUser(token) {
    ...
    axios.get(`https://glacial-ocean-39750.herokuapp.com/users/${username}`, {
  ...
  editUser(e) {
    ...
    axios.put(`https://glacial-ocean-39750.herokuapp.com/users/${username}`,
      {
  ...
  onDeleteUser() {
    const token = localStorage.getItem('token');
    const username = localStorage.getItem('user');
    axios.delete(`https://glacial-ocean-39750.herokuapp.com/users/${username}`, {
      headers: { Authorization: `Bearer ${token}` }
    })
      .then((response) => {
        console.log(response);
    ...
    return (
      <Container className="profile-view">
        ...
        <div className="profileInformation">
          ...
          <div className="profileContent">
            <h4><span className="birthday">  Birthday</span></h4>
            <div>
          ...
          <Form className="formDisplay" onSubmit={(e) => this.editUser(e)}>
            ...
            <div className="marginSpacer">
              <Button className="updateButton" variant="success" type="submit" >Update</Button>
            </div>
          </Form>
          <div className="marginSpacer">
            <Button className="deleteButton" variant="danger" onClick={() => this.onDeleteUser()} >Delete Profile</Button>
          </div>
        </div>
